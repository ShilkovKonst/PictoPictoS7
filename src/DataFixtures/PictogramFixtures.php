...
class PictogramFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($dataPicto as $row) {
            ...
            if ($row[14] == 1) {
                $pictogram->setCategory($this->catRepo->findOneByName("Sujets"));
            }
            if ($row[14] == 2) {
                $pictogram->setCategory($this->catRepo->findOneByName("Boissons"));
            }
            if ($row[14] == 3) {
                $pictogram->setCategory($this->catRepo->findOneByName("Actions"));
            }
            if ($row[14] == 4) {
                $pictogram->setCategory($this->catRepo->findOneByName("Adjectifs"));
            }
            if ($row[14] == 5) {
                $pictogram->setCategory($this->catRepo->findOneByName("Aliments"));
            }
            if ($row[14] == 6) {
                $pictogram->setCategory($this->catRepo->findOneByName("Animaux"));
            }
            if ($row[14] == 7) {
                $pictogram->setCategory($this->catRepo->findOneByName("Chiffres"));
            }
            if ($row[14] == 8) {
                $pictogram->setCategory($this->catRepo->findOneByName("Corps humain"));
            }
            if ($row[14] == 9) {
                $pictogram->setCategory($this->catRepo->findOneByName("Couleurs"));
            }
            if ($row[14] == 10) {
                $pictogram->setCategory($this->catRepo->findOneByName("Petits mots"));
            }
            if ($row[14] == 11) {
                $pictogram->setCategory($this->catRepo->findOneByName("Émotions"));
            }
            if ($row[14] == 12) {
                $pictogram->setCategory($this->catRepo->findOneByName("Fruits et légumes"));
            }
            if ($row[14] == 13) {
                $pictogram->setCategory($this->catRepo->findOneByName("Langues Des Signes"));
            }
            if ($row[14] == 14) {
                $pictogram->setCategory($this->catRepo->findOneByName("Lieux"));
            } 
            if ($row[14] == 15) {
                $pictogram->setCategory($this->catRepo->findOneByName("Météo"));
            } 
            if ($row[14] == 16) {
                $pictogram->setCategory($this->catRepo->findOneByName("Multimédia"));
            }
            if ($row[14] == 17) {
                $pictogram->setCategory($this->catRepo->findOneByName("Objets"));
            }
            if ($row[14] == 18) {
                $pictogram->setCategory($this->catRepo->findOneByName("Personnes"));
            }
            if ($row[14] == 19) {
                $pictogram->setCategory($this->catRepo->findOneByName("Scolarité"));
            }
            if ($row[14] == 20) {
                $pictogram->setCategory($this->catRepo->findOneByName("Transports"));
            }
            if ($row[14] == 21) {
                $pictogram->setCategory($this->catRepo->findOneByName("Vêtements"));
            }
            if ($row[14] == 22) {
                $pictogram->setCategory($this->catRepo->findOneByName("Comportements"));
            }
            if ($row[14] == 23) {
                $pictogram->setCategory($this->catRepo->findOneByName("Orientation"));
            }
            if ($row[14] == 24) {
                $pictogram->setCategory($this->catRepo->findOneByName("Autres Mots"));
            }
            if ($row[14] == 25) {
                $pictogram->setCategory($this->catRepo->findOneByName("Formes"));
            }
            if ($row[14] == 26) {
                $pictogram->setCategory($this->catRepo->findOneByName("Sports"));
            }
            if ($row[14] == 31) {
                $pictogram->setCategory($this->catRepo->findOneByName("Sécurité Routière"));
            }
            if ($row[14] == 33) {
                $pictogram->setCategory($this->catRepo->findOneByName("Jouet"));
            }
            if ($row[14] == 36) {
                $pictogram->setCategory($this->catRepo->findOneByName("Interrogatif"));
            }
            if ($row[14] == 37) {
                $pictogram->setCategory($this->catRepo->findOneByName("Journee"));
            }
            if ($row[14] == 39) {
                $pictogram->setCategory($this->catRepo->findOneByName("Heures"));
            }
            if ($row[14] == 41) {
                $pictogram->setCategory($this->catRepo->findOneByName("Couverts"));
            }
            
            $pictogram->setUpdatedAt($this->fixt->formatDateTimeByString($row[15]));
            $pictogram->setTherapist($this->therapistRepo->findOneById($row[16]));

            //=========================================================================
            if ($row[17] == 3) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("École"));
            }
            if ($row[17] == 4) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Maison"));
            }
            if ($row[17] == 6) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Magasins"));
            }
            if ($row[17] == 7) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Famille"));
            }
            if ($row[17] == 8) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Objets de la cuisine"));
            }
            if ($row[17] == 9) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Objets de la salle de bain"));
            }
            if ($row[17] == 10) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre A"));
            }
            if ($row[17] == 11) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre C"));
            }
            if ($row[17] == 12) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre D"));
            }
            if ($row[17] == 13) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre E"));
            }
            if ($row[17] == 14) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre L"));
            }
            if ($row[17] == 15) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre M"));
            }
            if ($row[17] == 16) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre N"));
            }
            if ($row[17] == 17) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre S"));
            }
            if ($row[17] == 18) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre T"));
            }
            if ($row[17] == 19) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre U"));
            }
            if ($row[17] == 20) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Lettre V"));
            }
            if ($row[17] == 22) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("Magasin"));
            }
            if ($row[17] == 27) {
                $pictogram->setSubCategory($this->subCatRepo->findOneByName("bar"));
            }
